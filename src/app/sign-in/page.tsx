...
export default function SignInPage() {
  ...
  useEffect(() => { document.title = "Sign In — Sibling Stack"; }, []);
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-bg px-2 text-ink-muted">or continue with</span>
          </div>
        </div>

        <button onClick={handleGoogleSignIn} disabled={googleLoading}
          className="w-full flex items-center justify-center gap-2 border border-surface2 rounded-md py-2 text-ink hover:bg-surface transition-colors disabled:opacity-60">
        ...
        <Link href="/" className="block text-ink-muted hover:text-ink text-sm mt-8 text-center transition-colors">
          Back to Home
        </Link>
      </div>
    </main>
