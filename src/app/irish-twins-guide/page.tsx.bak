...
export const metadata = {
  ...
  description:
    "What Irish twins actually means, where the term came from, the real challenges and the real upside â€” plus every SiblingStack guide, schedule, and tool organized by topic, in one place.",
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "No â€” they're two separate pregnancies, just close enough together that both kids spend part of childhood at overlapping ages and stages.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Not guaranteed, but it's common â€” shared developmental stages and near-identical childhood experiences tend to produce more playmate-style closeness earlier than a wider age gap typically allows.",
        },
      },
      {
        "@type": "Question",
...
const library = [
  ...
  {
    heading: "ðŸ’ž Wellbeing & Sibling Bond",
    items: [
...
const routines = [
  ...
  },
  {
    ...
    desc: "Both kids past the newborn stage (e.g. 14 + 26 months) â€” when a shared midday nap becomes realistic.",
    href: "/schedules/two-toddlers-sync",
  },
  {
    icon: "âš”ï¸",
    title: "Dueling Naps Schedule",
    desc: "Baby on 2 naps, toddler on 1 â€” one solid overlapping window, not full-day sync.",
  ...
  },
  {
    ...
    desc: "Infant twins plus an older toddler â€” double wake windows, feeding organization, sleep safety.",
  ...
  },
  {
    ...
    desc: "No nap overlap to find â€” routines for a preschooler home all day or in school part-time.",
...
const tools = [
  {
    ...
    desc: "Enter your baby's age and wake time to find the recommended time for their next nap â€” so you can put them down before overtiredness sets in.",
  ...
  },
  {
    ...
    desc: "Answer two quick questions to know which child to put to sleep first tonight â€” and when.",
  ...
  },
  {
    ...
    desc: "Enter both kids' ages and feeding frequency to get a suggested offset schedule â€” so you're never doing two simultaneous feeds solo.",
  ...
  },
  {
    ...
    desc: "Answer 5 quick questions about your toddler's nap resistance and daily mood to find out if they're ready to drop to one nap â€” or one nap to none.",
...
const timeline = [
  { label: "Year 1", baby: "Newborn baby", toddler: "Toddler (10â€“12 mo)" },
    ...
    <main className="min-h-screen itg-page">
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        <nav className="text-[13px] text-[#b5aa9a] mb-6">
          ...
          â€º <span className="text-[#f3ece0]">Irish Twins Guide</span>
        </nav>
        ...
        <header>
          ...
          <p className="text-[17px] text-[#b5aa9a] leading-relaxed mb-3">
            ...
            what&apos;s actually good â€” and every guide, schedule, and tool in one
            place.
          </p>
          <p className="text-[13.5px] text-[#b5aa9a] mb-8">
            BY <strong className="text-[#f3ece0]">JAMES T. REILLY</strong>{" "}
            <span className="mx-2">â€¢</span> AUG 2026
          </p>
        </header>
        ...
        >
          ...
          <ul className="pl-5 flex flex-col gap-1.5 text-[15px] text-[#ccc5b8] leading-relaxed" style={{ listStyle: "disc" }}>
            <li><strong>Irish twins</strong> means siblings born within 12 months of each other â€” not biological twins.</li>
        ...
        <div className="prose-sibling">
          <p>
            ...
            you&apos;re in the right place. This is the complete guide â€” what the
          ...
          <p>
            ...
            â€” just two separate pregnancies close enough together that both kids
          ...
          <p>
            ...
            England, where it was used â€” often cruelly â€” to mock Irish Catholic
          ...
          <p>
            ...
            insult and into general, casual use â€” most people who say it today
          ...
          <p>
            ...
            18â€“24 months between pregnancies for physical recovery reasons. That
            said, plenty of families have healthy pregnancies and healthy kids
            with a shorter gap â€” it&apos;s a real consideration to raise with
          ...
          >
            ...
            <p className="text-[15px] leading-relaxed text-[#ccc5b8]">
              ...
              care provider â€” especially if you&apos;ve recently had a C-section
          ...
          <h3>The real challenges â€” stated honestly</h3>
          <ul>
            <li>
          ...
          <p>
            ...
            manageable â€” which is most of what the rest of this site is about.
          </p>
          ...
          >
            ...
            <p className="text-[15px] leading-relaxed text-[#ccc5b8]" style={{ fontStyle: "italic" }}>
              ...
              diapering or the double gear â€” it&apos;s the split attention. When
          ...
          <p>
            ...
            age gap typically allows â€” they&apos;re at compatible stages for
          ...
          >
            ...
            <p className="text-[15px] leading-relaxed text-[#ccc5b8]" style={{ fontStyle: "italic" }}>
              ...
              playing together with the same toys â€” and on the exact same sleep
              schedule.&quot;
            </p>
          </div>
          ...
          <p>
            ...
            pattern, not a rare one â€” plenty of families end up here by choice,
          ...
          <p>
            ...
            stage on day one â€” identical sleep needs, identical feeding demands,
          ...
          <p>
            ...
            You&apos;re rarely doing &quot;two newborns&quot; â€” you&apos;re
          ...
          <p>
            ...
            because nothing is automatic yet â€” no established routine, no sense
          ...
          <ul>
            <li>
              ...
              Protecting even one 3â€“4 hour stretch â€” trading off with a partner,
              or accepting help specifically for that block â€” does more for
              functioning than chasing a full night that isn&apos;t realistic
              yet.
            </li>
            <li>
              <strong>Lower every standard that isn&apos;t safety.</strong>{" "}
              Meals, house tidiness, &quot;quality&quot; screen time limits â€” all
            ...
            <li>
              ...
              autopilot â€” anything decided once, in advance, is one less decision
              you have to make at 2 AM.
            </li>
            <li>
              <strong>Accept help you&apos;d normally decline.</strong> A grocery
              run, a load of laundry, an hour of toddler supervision â€” the first
          ...
          <p>
            One of the most useful ways to picture a 10â€“12 month gap is to see
        ...
        <div className="prose-sibling">
          <p>
            ...
            stages for years â€” toddler-to-toddler, then preschooler-out-of-step,
          ...
          <h2 id="library">
            Every guide, schedule, and tool â€” organized by what you&apos;re
            dealing with right now
          </h2>
          <p>
            Below is the full library, grouped the way you&apos;re actually
            experiencing this stage â€” not by publish date. Jump to whichever
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
          {library.map((group) => (
            <div key={group.heading} className="flex flex-col gap-4">
              ...
              {group.heading === "ðŸ›ï¸ Sleep & Schedules" && (
                <div
        ...
        <div className="prose-sibling">
          ...
          <p>
            ...
            <br />
            No â€” they&apos;re two separate pregnancies, just close enough
          ...
          <p>
            ...
            bigger gap?</strong>
            <br />
            Not guaranteed, but it&apos;s common â€” shared developmental stages and
          ...
          >
            ...
            <p className="text-[15px] leading-relaxed text-[#ccc5b8]" style={{ fontStyle: "italic" }}>
              &quot;Closeness in age doesn&apos;t guarantee closeness in bond â€”
          ...
          <p>
            ...
            are hard â€” just in different ways.
          </p>
          <p>
            <strong>How do you survive the first 3 months with Irish twins?</strong>
            <br />
            Protect one 3â€“4 hour sleep block instead of chasing a full night,
